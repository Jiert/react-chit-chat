...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commentBox = __webpack_require__(157);
	...
	(function () {
	  ...
	  var data = {
	    firebase: new _firebase2['default']('https://blinding-torch-9943.firebaseio.com/')
	  };
	  ...
	  _react2['default'].render(_react2['default'].createElement(_commentBox2['default'], { data: data }), document.getElementById('main-content'));

	  _react2['default'].render(_react2['default'].createElement(_login2['default'], { data: data }), document.getElementById('main-sidebar-nav')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commentList = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    var commentNodes = this.props.data && _underscore2['default'].toArray(this.props.data).map(function (comment) {
	      return _react2['default'].createElement(
	        _comment2['default'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  authCallback: function authCallback(error, authData) {
	    if (error) {
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'form',
	      { className: 'commentForm', onSubmit: this.handleSubmit },
	      _react2['default'].createElement('input', { name: 'email', onChange: this.onChange, type: 'email', className: 'form-control', value: this.state.user, placeholder: 'email address', ref: 'email' }),
	      _react2['default'].createElement('input', { name: 'password', onChange: this.onChange, type: 'password', className: 'form-control', value: this.state.password, placeholder: 'password', ref: 'password' }),
	      _react2['default'].createElement('input', { type: 'submit', className: 'btn btn-primary', value: 'Post' })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginForm = __webpack_require__(164);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  authDataCallback: function authDataCallback(auth) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.email.length) {
	      loginButton = _react2['default'].createElement(_logout2['default'], { data: this.props.data });
	    } else {
	      loginButton = _react2['default'].createElement(_loginForm2['default'], { data: this.props.data });
	    }
