...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_auth2['default'], null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    return { fire: new _firebase2['default']('https://blinding-torch-9943.firebaseio.com/') };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _loginForm = __webpack_require__(165);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      'form',
	      { className: 'commentForm', onSubmit: this.handleSubmit },
	      _react2['default'].createElement('input', { name: 'email', onChange: this.onChange, type: 'email', value: this.state.email, className: 'form-control', placeholder: 'email address', ref: 'email' }),
	      _react2['default'].createElement('input', { name: 'password', onChange: this.onChange, type: 'password', value: this.state.password, className: 'form-control', placeholder: 'password', ref: 'password' }),
	      _react2['default'].createElement('input', { type: 'submit', className: 'btn btn-primary', value: 'Post' })
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  render: function render() {
	    return _react2['default'].createElement(
	      'button',
	      { type: 'submit', className: 'btn', onClick: this.onLogout },
	      'Log out'
	    );
	  }
	});
